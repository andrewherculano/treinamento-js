...
const lastItemBrazilianFoods = brazilianFoods[brazilianFoods.length - 1]
const formatBrazilianFoodsArray = brazilianFoods
    .join(', ')
    .replace(`, ${lastItemBrazilianFoods}`, ` e ${lastItemBrazilianFoods}`)

const foodsInfo = `Até aqui, o array "brazilianFoods" possui ${brazilianFoods.length} itens: ${formatBrazilianFoodsArray}.`
...
const femaleDogNames = ['Matilda', 'Lilica']
...
const lastItemDogNames = dogNames[dogNames.length - 1]
console.log(lastItemDogNames)
