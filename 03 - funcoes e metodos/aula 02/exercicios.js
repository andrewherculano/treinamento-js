...
const convertToString2 = value => String(value)
const showValue = convertToString(21398129)
...
console.log(countCharacters('teste'))
...
const convertInUpperCase = sentente => sentente.toLowerCase()
const showSentence = convertInUpperCase('CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO')
...
const getCharIndex = (char, string) => string.indexOf(char)
const charIndex = getCharIndex('s', 'teste')
...
const doesItemExistInArray = (array, item) => array.includes(item)
console.log(doesItemExistInArray([1, 2, 3], 5))
...
const mergeArrays = (array1, array2) => array2.concat(array1)
